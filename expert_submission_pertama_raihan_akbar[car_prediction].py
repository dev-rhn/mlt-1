# -*- coding: utf-8 -*-
"""Expert_Submission_Pertama_Raihan Akbar[Car Prediction].ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1vidnDcqDVWtsYzGsMNWxpG-xdIvL40QH
...
Berdasarkan output yang dihasilkan didapati bahwa model **Fiesta** menjadi model yang paling banyak terjual dengan total 6.198 dan disusul model **Focus** dengan 4.171 dan model **Kuga** dengan 2.065. Selain itu juga banyak model lain yang terjual namun tidak sebanyak 3 model mobil sebelumnya.
"""
...
"""Berdasarkan output yang dihasilkan transmission yang paling banyak adalah Manual dengan 87% dari total data yang ada. Hal ini menunjukkan model mobil dengan transmission Manual merupakan model yang paling laku dipasaran"""
